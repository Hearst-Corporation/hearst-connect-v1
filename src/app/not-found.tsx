    ...
    <main className="grid min-h-dvh place-items-center bg-white px-6 py-24 sm:py-32 lg:px-8 dark:bg-zinc-900">
      <div className="text-center">
        ...
        <div className="mt-10 flex items-center justify-center gap-x-6">
          <Link
            href="/"
            className="rounded-md bg-accent-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-accent-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent-600 dark:bg-accent-500 dark:hover:bg-accent-400"
          >
            Retour à l’accueil
          </Link>
