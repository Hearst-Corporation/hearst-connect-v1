...
/**
 * Pilotage des souscriptions — parcours client, pas le patrimoine.
 * Question : où en est chaque client, et qu’est-ce qui attend une décision ?
 * Le cockpit (`/admin`) porte dérive / TVL / file patrimoine.
 */
