...
const colors = {
  ...
  neutral: 'bg-console-fill/10 text-console-fill-muted group-data-hover:bg-console-fill/20 dark:bg-fg/5 dark:text-fg-secondary dark:group-data-hover:bg-fg/10',
}
