...
const colors = {
  ...
  neutral: 'bg-console-fill/10 text-console-fill-muted group-data-hover:bg-console-fill/20 dark:bg-white/5 dark:text-fg-secondary dark:group-data-hover:bg-white/10',
}

type BadgeProps = { color?: keyof typeof colors }

export function Badge({ color = 'neutral', className, ...props }: BadgeProps & React.ComponentPropsWithoutRef<'span'>) {
  return (
    <span
      {...props}
      className={clsx(
