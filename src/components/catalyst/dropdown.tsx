...
export function DropdownItem({
  ...
  let classes = clsx(
    ...
    '*:data-[slot=icon]:text-fg-tertiary data-focus:*:data-[slot=icon]:text-white dark:*:data-[slot=icon]:text-fg-secondary dark:data-focus:*:data-[slot=icon]:text-white',
    // Avatar
...
export function DropdownHeading({
  ...
  return (
    <Headless.MenuHeading
      ...
      className={clsx(
        className,
        'col-span-full grid grid-cols-[1fr_auto] gap-x-12 px-3.5 pt-2 pb-1 text-sm/5 font-medium text-fg-tertiary sm:px-3 sm:text-xs/5 dark:text-fg-secondary'
      )}
    />
  )
}
...
export function DropdownDivider({
  ...
  return (
    <Headless.MenuSeparator
      ...
      className={clsx(
        className,
        'col-span-full mx-3.5 my-1 h-px border-0 bg-ink/5 sm:mx-3 dark:bg-white/10 forced-colors:bg-[CanvasText]'
      )}
    />
  )
}
...
export function DropdownDescription({
  ...
  return (
    <Headless.Description
      ...
      className={clsx(
        className,
        'col-span-2 col-start-2 row-start-2 text-sm/5 text-fg-tertiary group-data-focus:text-white sm:text-xs/5 dark:text-fg-secondary forced-colors:group-data-focus:text-[HighlightText]'
      )}
    />
  )
}
    ...
    >
      {(Array.isArray(keys) ? keys : keys.split('')).map((char, index) => (
        <kbd
          key={index}
          className={clsx([
            'min-w-[2ch] text-center font-sans text-fg-secondary capitalize group-data-focus:text-white forced-colors:group-data-focus:text-[HighlightText]',
