    ...
    <Headless.Combobox {...props} multiple={false} virtual={{ options: filteredOptions }} onClose={() => setQuery('')}>
      ...
      >
        ...
        <Headless.ComboboxButton className="group absolute inset-y-0 right-0 flex items-center px-2">
          <svg
            className="size-5 stroke-fg-tertiary group-data-disabled:stroke-console-fill group-data-hover:stroke-console-fill-muted sm:size-4 dark:stroke-fg-secondary dark:group-data-hover:stroke-fg forced-colors:stroke-[CanvasText]"
            viewBox="0 0 16 16"
            aria-hidden="true"
            fill="none"
          >
