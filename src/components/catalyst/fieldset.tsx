...
export function Legend({
  ...
  return (
    <Headless.Legend
      ...
      className={clsx(
        className,
        'text-base/6 font-semibold text-ink data-disabled:opacity-50 sm:text-sm/6 dark:text-white'
      )}
    />
  )
}
...
export function Label({ className, ...props }: { className?: string } & Omit<Headless.LabelProps, 'as' | 'className'>) {
  return (
    <Headless.Label
      ...
      className={clsx(
        className,
        'text-base/6 text-ink select-none data-disabled:opacity-50 sm:text-sm/6 dark:text-white'
      )}
    />
  )
}
...
export function Description({
  ...
  return (
    <Headless.Description
      ...
      {...props}
      className={clsx(className, 'text-base/6 text-fg-tertiary data-disabled:opacity-50 sm:text-sm/6 dark:text-fg-secondary')}
    />
  )
}
