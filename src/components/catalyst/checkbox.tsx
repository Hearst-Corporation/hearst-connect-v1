...
const base = [
  ...
  // Border
  'border border-ink/15 group-data-checked:border-transparent group-data-hover:group-data-checked:border-transparent group-data-hover:border-ink/30 group-data-checked:bg-(--checkbox-checked-border)',
  ...
  'group-data-disabled:border-ink/25 group-data-disabled:bg-ink/5 group-data-disabled:[--checkbox-check:var(--color-ink)]/50 group-data-disabled:before:bg-transparent',
...
const colors = {
  'dark/neutral': [
    '[--checkbox-check:var(--color-white)] [--checkbox-checked-bg:var(--color-console-shell)] [--checkbox-checked-border:var(--color-ink)]/90',
    'dark:[--checkbox-checked-bg:var(--color-console-fill)]',
  ],
  'dark/white': [
    '[--checkbox-check:var(--color-white)] [--checkbox-checked-bg:var(--color-console-shell)] [--checkbox-checked-border:var(--color-ink)]/90',
    'dark:[--checkbox-check:var(--color-console-shell)] dark:[--checkbox-checked-bg:var(--color-white)] dark:[--checkbox-checked-border:var(--color-ink)]/15',
  ],
  white:
    '[--checkbox-check:var(--color-console-shell)] [--checkbox-checked-bg:var(--color-white)] [--checkbox-checked-border:var(--color-ink)]/15',
  dark: '[--checkbox-check:var(--color-white)] [--checkbox-checked-bg:var(--color-console-shell)] [--checkbox-checked-border:var(--color-ink)]/90',
  neutral: '[--checkbox-check:var(--color-white)] [--checkbox-checked-bg:var(--color-console-fill)] [--checkbox-checked-border:var(--color-console-fill-muted)]/90',
