...
const base = [
  ...
  // Border
  'border border-ink/15 group-data-checked:border-transparent group-data-hover:group-data-checked:border-transparent group-data-hover:border-ink/30 group-data-checked:bg-(--radio-checked-border)',
  ...
  '[--radio-indicator:transparent] group-data-checked:[--radio-indicator:var(--radio-checked-indicator)] group-data-hover:group-data-checked:[--radio-indicator:var(--radio-checked-indicator)] group-data-hover:[--radio-indicator:var(--color-console-shell)]/10',
  // Indicator color (dark mode)
  'dark:group-data-hover:group-data-checked:[--radio-indicator:var(--radio-checked-indicator)] dark:group-data-hover:[--radio-indicator:var(--color-console-fill-muted)]',
  // Focus ring
  'group-data-focus:outline group-data-focus:outline-2 group-data-focus:outline-offset-2 group-data-focus:outline-blue-500',
  // Disabled state
  'group-data-disabled:opacity-50',
  'group-data-disabled:border-ink/25 group-data-disabled:bg-ink/5 group-data-disabled:[--radio-checked-indicator:var(--color-ink)]/50 group-data-disabled:before:bg-transparent',
...
const colors = {
  'dark/neutral': [
    '[--radio-checked-bg:var(--color-console-shell)] [--radio-checked-border:var(--color-ink)]/90 [--radio-checked-indicator:var(--color-white)]',
    'dark:[--radio-checked-bg:var(--color-console-fill)]',
  ],
  'dark/white': [
    '[--radio-checked-bg:var(--color-console-shell)] [--radio-checked-border:var(--color-ink)]/90 [--radio-checked-indicator:var(--color-white)]',
    'dark:[--radio-checked-bg:var(--color-white)] dark:[--radio-checked-border:var(--color-ink)]/15 dark:[--radio-checked-indicator:var(--color-console-shell)]',
  ],
  white:
    '[--radio-checked-bg:var(--color-white)] [--radio-checked-border:var(--color-ink)]/15 [--radio-checked-indicator:var(--color-console-shell)]',
  dark: '[--radio-checked-bg:var(--color-console-shell)] [--radio-checked-border:var(--color-ink)]/90 [--radio-checked-indicator:var(--color-white)]',
  neutral: '[--radio-checked-indicator:var(--color-white)] [--radio-checked-bg:var(--color-console-fill)] [--radio-checked-border:var(--color-console-fill-muted)]/90',
