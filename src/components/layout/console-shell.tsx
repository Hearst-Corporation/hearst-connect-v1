 ...
 *
 * Ce shell est le SEUL ancêtre commun des routes admin : c'est donc ici, et
 * nulle part ailleurs, que le contexte sombre doit être déclaré. Il l'était
 * autrefois par `admin-shell.tsx` (supprimé au Lot 7) ; le `dark` ci-dessous
 * a repris ce rôle.
 */
