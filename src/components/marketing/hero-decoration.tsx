/** Decorative hero background — grid mask and mint glow. */
export function HeroGridPattern({ id }: Readonly<{ id: string }>) {
  return (
    <svg
      aria-hidden="true"
    ...
    >
      <defs>
        <pattern x="50%" y={-1} id={id} width={200} height={200} patternUnits="userSpaceOnUse">
