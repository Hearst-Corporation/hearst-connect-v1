...
const SURFACES = [
  ...
  { route: '/admin/product', nom: 'admin-product-desktop', w: 1440, h: 900 },
  { route: '/admin/vaults', nom: 'admin-vaults-table', w: 1440, h: 900 },
  { route: '/admin/btc', nom: 'chart-panel', w: 1440, h: 900 },
  ...
  { route: '/admin/mining', nom: 'admin-mining-desktop', w: 1440, h: 900 },
