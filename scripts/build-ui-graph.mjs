...
function catalog() {
  ...
  n({
    ...
    domain: 'account',
    source: 'src/features/user-dashboard/user-dashboard.tsx',
    evidence: 'section.kpis aria-label="Account indicators"',
    geometryOwner: 'layout',
    dataSlotOwner: 'component',
    datasetControlsGeometry: false,
    surface: { kind: 'account:user-shell' },
  ...
  n({
    ...
    domain: 'account',
    source: 'src/features/user-dashboard/user-dashboard.tsx',
    evidence: 'section.analysis aria-label="Analysis"',
    geometryOwner: 'layout',
    dataSlotOwner: 'component',
    datasetControlsGeometry: false,
    surface: { kind: 'account:user-shell' },
  ...
  n({
    ...
    domain: 'account',
    source: 'src/features/user-dashboard/user-dashboard.tsx',
    evidence: 'aria-label="Central chart" + .center-plot',
    geometryOwner: 'component',
    dataSlotOwner: 'component',
    datasetControlsGeometry: false,
    surface: { kind: 'account:user-shell' },
  ...
  n({
    ...
    domain: 'account',
    source: 'src/features/user-dashboard/user-dashboard.tsx',
    evidence: 'section.movements aria-label="Account movements"',
    geometryOwner: 'layout',
    dataSlotOwner: 'component',
    datasetControlsGeometry: false,
    surface: { kind: 'account:user-shell' },
